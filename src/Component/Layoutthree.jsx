          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-5 md:pt-14">
            <div className="text-center md:text-left md:pl-28">
              <h1 className="text-3xl md:text-4xl p-2 leading-relaxed">
                <span className="text-indigo-300">informed Ai models that can</span><br />
                <span className="text-indigo-300">suggest relevant billable</span><br />
                <span className="text-indigo-300">accurately capture range</span><br />
                <span className="text-indigo-300"> diagnossis code and goals that</span><br />
                <span className="text-indigo-300">support medical necessity</span>
              </h1>
            </div>
